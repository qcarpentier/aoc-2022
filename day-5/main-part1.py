...
for move in movements:
    ...
    for i in range(move_count):
        # Insert the crane (the first element of the stack_from) as the first element of the stack_to
        vertical_stacks[stack_to].insert(0, vertical_stacks[stack_from][0])
